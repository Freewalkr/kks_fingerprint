...
(function (window) {
 ...
 function idb() {
  ...
  function Evercookie(options) {
    ...
    this.evercookie_lso = async function (name, value) {
      ...
      await new Promise((resolve,reject) => waitForSwf(resolve));
    ...
    var waitForSwf = this.waitForSwf = async function (resolve, i) {
      if (i === undefined) {
        i = 0;
      } else {
        i++;
